...
if args.cohC>0:
	filename = "./Data/evol%04d_coherent_cavity.txt" % (args.ID)
	outname = "./Data/OUT%04d_coherent_cavity.txt" % (args.ID)
	specname = "./Data/spec%04d_coherent_cavity.txt" % (args.ID)
	g2tau = "./Data/g2tau%04d_coherent_cavity.txt" % (args.ID)
	corrf = "./Data/corr%04d_coherent_cavity.txt" % (args.ID)
	Bdenspath = "./Data/Bdens%04d_coherent_cavity" % (args.ID)
	Cdenspath = "./Data/Cdens%04d_coherent_cavity" % (args.ID)
elif args.cohE>0:
	filename = "./Data/evol%04d_coherent_environment.txt" % (args.ID)
	outname = "./Data/OUT%04d_coherent_environment.txt" % (args.ID)
	specname = "./Data/spec%04d_coherent_environment.txt" % (args.ID)
	g2tau = "./Data/g2tau%04d_coherent_environment.txt" % (args.ID)
	corrf = "./Data/corr%04d_coherent_environment.txt" % (args.ID)
	Bdenspath = "./Data/Bdens%04d_coherent_environment" % (args.ID)
	Cdenspath = "./Data/Cdens%04d_coherent_environment" % (args.ID)
elif Ome>0:
	filename = "./Data/evol%04d_atom_drive_A.txt" % (args.ID)
	outname = "./Data/OUT%04d_atom_drive_A.txt" % (args.ID)
	specname = "./Data/spec%04d_atom_drive_A.txt" % (args.ID)
	g2tau = "./Data/g2tau%04d_atom_drive_A.txt" % (args.ID)
	corrf = "./Data/corr%04d_atom_drive_A.txt" % (args.ID)
	Bdenspath = "./Data/Bdens%04d_atom_drive_A" % (args.ID)
	Cdenspath = "./Data/Cdens%04d_atom_drive_A" % (args.ID)
elif Omc>0:
	filename = "./Data/evol%04d_cavity_drive.txt" % (args.ID)
	outname = "./Data/OUT%04d_cavity_drive.txt" % (args.ID)
	specname = "./Data/spec%04d_cavity_drive.txt" % (args.ID)
	g2tau = "./Data/g2tau%04d_cavity_drive.txt" % (args.ID)
	corrf = "./Data/corr%04d_cavity_drive.txt" % (args.ID)
	Bdenspath = "./Data/Bdens%04d_cavity_drive" % (args.ID)
	Cdenspath = "./Data/Cdens%04d_cavity_drive" % (args.ID)
else:
	filename = "./Data/evol%04d.txt" % (args.ID)
	outname = "./Data/OUT%04d.txt" % (args.ID)
	specname = "./Data/spec%04d.txt" % (args.ID)
	g2tau = "./Data/g2tau%04d.txt" % (args.ID)
	corrf = "./Data/corr%04d.txt" % (args.ID)
	Bdenspath = "./Data/Bdens%04d" % (args.ID)
	Cdenspath = "./Data/Cdens%04d" % (args.ID)
...
#	g2_ta,NB = g2_t(states[M],N_env+1,dt)
	...
	NB    = np.einsum("ij,ij",nB,Bdens)
	g2_t  = np.einsum("ij,ij",g2Bop,Bdens)/NB**2
...
#	om = np.fftfreq(N-L-1,dt)
	spec_real,spec_imag,corr = spectrum(states,om,args.spec_cutoff*L,N_env+1,dt,N-2-L)#,NB*dt)
	tau,g2_outa = g2_out(states,args.spec_cutoff*L,N_env+1,dt,N-L-2)
	time_out = np.transpose(np.vstack((om,spec_real,spec_imag)))
	f = open(specname, 'a')
	f.close()
	f = open(specname, 'r+')
	f.truncate()
